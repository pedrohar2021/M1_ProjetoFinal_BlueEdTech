...
while (true){
    ...
    while(continuar = 'S'){
        ...
        let valores = { energia:50, tecnica:50, confianca:50, dias: 1, fases:1, horas:12} // OBJETO COM STATUS DO PERSONAGEM E PASSAGEM DO TEMPO
